...
public class RigCoreBluetooth implements IRigCoreListener {
    ...
    private static final String RigCoreBluetoothLibraryVersion = "Rigablue Library v" + "NEO";
    ...
    public RigService getBluetoothLeService() {
    ...
    void fakeConnect(BluetoothGatt gatt) {
        RigLog.d("__Fake connected a gatt__");
        if (!checkBluetoothState()) {
            return;
        }
        mBluetoothLeService.fakeConnect(gatt);
    }
