...
public class RigService {
    ...
    public HashMap<String, BluetoothGatt> getBluetoothGattHashMap() {
        return this.mBluetoothGattHashMap;
    }
    public HashMap<String, BluetoothGattCallback> getBluetoothGattCallbackHashMap() {
        return this.mBluetoothGattCallbackHashMap;
    }
    public IRigCoreListener getRigCoreListener() {
        return this.mRigCoreListener;
    }
    /**
